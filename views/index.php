...
<nav class=" container navbar navbar-expand-lg ">
    <div class="container-fluid">
        <a class="navbar-brand logo" href="#">My Forum</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex">
                <a href="register.php" class="btn btn-outline-danger" type="submit">Sign up</a>
            </form>
        </div>
    </div>
</nav>
    <div class="container login-cont ">
        ...
        <p style="font-weight: 50">Don't have an account? <a style="font-weight: bold; color:black;" href="register.php">Reguest Now</a></p>
